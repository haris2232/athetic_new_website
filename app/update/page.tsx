...
export default function UpdatePage() {
  ...
  const scrollCarousel = (direction: 'left' | 'right') => {
    if (carouselRef.current) {
      ...
      // Figma box width: 276px (responsive: clamp(200px, 21.5vw, 276px))
      const imageWidth = Math.max(200, Math.min(276, carouselRef.current.clientWidth * 0.215)) // Responsive width
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            ...
            <Link 
              ...
              style={{
                ...
                backgroundSize: 'cover', // Cover entire card - responsive
                backgroundPosition: '70% center', // Face visible - adjust position for face (70% from left to show face on right)
            ...
            <Link 
              ...
              style={{
                ...
                backgroundImage: 'url(/6.png)',
                backgroundSize: 'cover', // Cover entire card - responsive
                backgroundPosition: '70% center', // Face visible - same for all cards
                backgroundRepeat: 'no-repeat',
        ...
        <div className="container mx-auto px-4 max-w-[1250px]">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-black bg-white flex items-center justify-center hover:bg-black hover:text-white transition-colors shadow-lg"
            ...
            <button
              ...
              className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-black bg-white flex items-center justify-center hover:bg-black hover:text-white transition-colors shadow-lg"
              aria-label="Next image"
            >
              <ChevronRight className="w-5 h-5 md:w-6 md:h-6" />
            </button>

            {/* Carousel Container - Shows multiple images - Responsive */}
            <div 
              ref={carouselRef}
              ...
              {carouselImages.map((image, index) => (
                <div
                  ...
                  style={{
                    ...
                    // Exact Figma dimensions - responsive scaling
                    width: 'clamp(200px, 21.5vw, 276px)', // Figma: 276px - responsive (small: 200px, large: 276px)
                    height: 'clamp(310px, 33.5vw, 431px)', // Figma: 431px - responsive (small: 310px, large: 431px)
                    minWidth: '200px',
                    minHeight: '310px'
                  }}
                >
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 'clamp(35px, 3.9vw, 49.86px)', // Figma: 49.86px - responsive (small: 35px, large: 49.86px)
                  ...
                  >
                    <Image
                      ...
                      style={{
                        borderRadius: 'clamp(35px, 3.9vw, 49.86px)', // Same border radius as container
                        objectFit: 'cover' // Fit image inside box
                      }}
                      sizes="(max-width: 640px) 200px, (max-width: 768px) 240px, (max-width: 1024px) 260px, 276px"
                    />
                  </div>
                </div>
              ))}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (carouselRef.current) {
                    ...
                    const gap = 24
                    // Figma box width: 276px (responsive: clamp(200px, 21.5vw, 276px))
                    const imageWidth = Math.max(200, Math.min(276, containerWidth * 0.215)) // Responsive width
